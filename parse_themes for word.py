...
def populate_data_structures(ws ):
    ...
    return theme_dict_codes_and_answers
...
if __name__ == "__main__":
    excel_file = load_workbook('Interviews_and_Codes.xlsx')
    work_sheet = excel_file.active
    generated_excel_file = load_workbook('Result.xlsx')
    results_work_sheet = generated_excel_file.active
    all_the_datas = populate_data_structures(work_sheet)
    count_freq(all_the_datas)
